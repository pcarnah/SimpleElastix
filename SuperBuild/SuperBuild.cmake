...
# Lua
#------------------------------------------------------------------------------
option ( SimpleElastix_USE_SYSTEM_LUA "Use a pre-compiled version of LUA 5.1 previously configured for your system" OFF )
sitk_legacy_naming( SimpleElastix_USE_SYSTEM_LUA USE_SYSTEM_LUA)
mark_as_advanced(SimpleElastix_USE_SYSTEM_LUA)
if ( SimpleElastix_USE_SYSTEM_LUA )
...
# Swig
#------------------------------------------------------------------------------
option ( SimpleElastix_USE_SYSTEM_SWIG "Use a pre-compiled version of SWIG 3.0 previously configured for your system" OFF )
sitk_legacy_naming( SimpleElastix_USE_SYSTEM_SWIG USE_SYSTEM_SWIG )
mark_as_advanced(SimpleElastix_USE_SYSTEM_SWIG)
if(SimpleElastix_USE_SYSTEM_SWIG)
...
# Google Test
#------------------------------------------------------------------------------
option( SimpleElastix_USE_SYSTEM_GTEST "Use an external version of GoogleTest. " OFF )
sitk_legacy_naming( SimpleElastix_USE_SYSTEM_GTEST USE_SYSTEM_GTEST )
mark_as_advanced(SimpleElastix_USE_SYSTEM_GTEST)
if ( BUILD_TESTING )
  if (SimpleElastix_USE_SYSTEM_GTEST)
...
# Python virtualenv
#------------------------------------------------------------------------------
option( SimpleElastix_USE_SYSTEM_VIRTUALENV "Use a system version of Python's virtualenv. " OFF )
sitk_legacy_naming( SimpleElastix_USE_SYSTEM_VIRTUALENV USE_SYSTEM_VIRTUALENV)
mark_as_advanced(SimpleElastix_USE_SYSTEM_VIRTUALENV)
if( NOT DEFINED SimpleITK_PYTHON_USE_VIRTUALENV OR SimpleITK_PYTHON_USE_VIRTUALENV )
  if ( SimpleElastix_USE_SYSTEM_VIRTUALENV )
...
option(SimpleElastix_USE_SYSTEM_ITK "Use a pre-built version of ITK" OFF)
sitk_legacy_naming( SimpleElastix_USE_SYSTEM_ITK USE_SYSTEM_ITK )
mark_as_advanced(SimpleElastix_USE_SYSTEM_ITK)
if(SimpleElastix_USE_SYSTEM_ITK)
...
option(SimpleElastix_USE_SYSTEM_SimpleITK "Use a pre-built version of SimpleITK" OFF)
sitk_legacy_naming( SimpleElastix_USE_SYSTEM_SimpleITK USE_SYSTEM_ITK )
mark_as_advanced(SimpleElastix_USE_SYSTEM_SimpleITK)
if(SimpleElastix_USE_SYSTEM_SimpleITK)
...
option(SimpleElastix_USE_SYSTEM_ELASTIX "Use system install of elastix." OFF)
sitk_legacy_naming(SimpleElastix_USE_SYSTEM_ELASTIX USE_SYSTEM_ELASTIX)
mark_as_advanced(SimpleElastix_USE_SYSTEM_ELASTIX)

if(SimpleElastix_USE_SYSTEM_ELASTIX)
...
file(WRITE "${CMAKE_CURRENT_BINARY_DIR}/SimpleElastix-build/CMakeCacheInit.txt" "${ep_simpleitk_cache}${ep_common_cache}\n${ep_languages_cache}" )

set(proj SimpleElastix)
ExternalProject_Add(${proj}
  DOWNLOAD_COMMAND ""
  SOURCE_DIR ${CMAKE_CURRENT_SOURCE_DIR}/..
  BINARY_DIR SimpleElastix-build
  INSTALL_DIR ${CMAKE_INSTALL_PREFIX}
  CMAKE_GENERATOR ${gen}
  CMAKE_ARGS
    --no-warn-unused-cli
    -DCMAKE_TOOLCHAIN_FILE:FILEPATH=${CMAKE_TOOLCHAIN_FILE}
    -C "${CMAKE_CURRENT_BINARY_DIR}/SimpleElastix-build/CMakeCacheInit.txt"
    ${ep_simpleitk_args}
    ${ep_common_args}
